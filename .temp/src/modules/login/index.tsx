  ...
  return (
    <div>
      <Form
        ...
        autoComplete='off'
      >
        <Form.Item name='acount' rules={[required]}>
          <Input placeholder={locales.username} prefix={<UserOutlined />} />
        </Form.Item>

        <Form.Item name='password' rules={[required]}>
          <Input prefix={<LockOutlined />} type='password' placeholder={locales.pwd} />
        </Form.Item>
  ...
  return (
    <div className='login-tab-enterprise-form'>
      <Form
        ...
        autoComplete='off'
      >
        <Form.Item name='companyCode' rules={[required]}>
          <Input placeholder={locales.companyCode} prefix={<IdcardOutlined />} />
        </Form.Item>

        <Form.Item name='loginName' rules={[required]}>
          <Input placeholder={locales.username} prefix={<UserOutlined />} />
        </Form.Item>

        <Form.Item name='pwd' rules={[required]}>
          <Input prefix={<LockOutlined />} type='password' placeholder={locales.pwd} />
        </Form.Item>
...
const FinitLoginForm = injectIntl(
  inject(namespace)(
    observer((props: any) => {
      ...
      return (
        <div className='ar-login-form'>
          <Tabs defaultActiveKey='2' centered onChange={(key: any): void => callback(key)}>
